...
Arguments:
    <base_directory> - The base directory of a placeh source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Placeholder Core developers'
...
Arguments:
    <file> - A source file in the placeh repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Placeh
