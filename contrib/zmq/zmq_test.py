...
"""
    ...
    Placeh should be started with the command line arguments:
        placehd -testnet -daemon \
...
print("Getting Placeholders msgs")
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND PHL issuance at " + str(pos))
				print("After PHL: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND PHL something at " + str(pos))
			start += pos+8
			print(astr)
