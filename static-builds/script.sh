...
find ${DISTNAME}/bin -type f -executable -exec ../placehcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../placehcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/placehcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/placehcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
