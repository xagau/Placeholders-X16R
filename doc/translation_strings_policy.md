...
This document provides guidelines for internationalization of the Placeholder Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `placeh_en.ts` remains unchanged.
