...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/PlacehProject/Placeholders/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/PlacehProject/Placeholders/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
* Update hardcoded [seeds](/contrib/seeds/README.md), see [this pull request](https://github.com/PlacehProject/Placeholders/pull/7415) for an example.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the placeh.org server
...
- Announce the release:
  ...
  - Placeholder Core announcements list https://placeh.io/en/list/announcements/join/
  ...
  - Create a [new GitHub release](https://github.com/PlacehProject/Placeholders/releases/new) with a link to the archived release notes.
