...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<PlacehAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_placeh-qt -platform xcb      # Linux
//     src/qt/test/test_placeh-qt -platform windows  # Windows
//     src/qt/test/test_placeh-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = PlacehUnits::formatWithUnit(unit, balance, false, PlacehUnits::separatorAlways);
    ...
    // Amount input
    PlacehAmountField* amountInput = receiveCoinsDialog.findChild<PlacehAmountField*>("reqAmount");
