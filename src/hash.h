...
/** A hasher class for Placeh's 256-bit hash (double SHA-256). */
class CHash256 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for Placeh's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
    CSHA256 sha;
public:
...
template<typename T1>
inline uint256 HashX16RV3(const T1 pbegin, const T1 pend, const uint256 PrevBlockHash)
{
//      static std::chrono::duration<double>[16];
    int hashSelection;
