...
public:
     ...
     * on this placeh node, and set to 0 for transactions that were created
...
public:
    ...
    /**
     * Helper function that calls AvailableCoinsAll, used to receive all coins, Assets and PHL
     */
