...
from test_framework.test_framework import PlacehTestFramework, SkipTest
...
class ZMQTest (PlacehTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that placeh has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("placehd has not been built with zmq enabled.")
