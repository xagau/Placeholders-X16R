...
Test plan:
- Start placehd's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on placehd side:
...
- Create placehds that connect to them
- Manipulate the placehds using addnode (onetry) an observe effects
