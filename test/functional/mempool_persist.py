...
By default, placehd will dump mempool on shutdown and
...
class MempoolPersistTest(PlacehTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give placehd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent placehd from writing mempool.dat to disk. Verify that `savemempool` fails")
