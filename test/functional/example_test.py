...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the PlacehTestFramework
    pass

class ExampleTest(PlacehTestFramework):
    # Each functional test is a subclass of the PlacehTestFramework class.
    ...
    def custom_method(self):
        ...
        PlacehTestFramework class so other tests can use it."""
