...
# TestNode: A peer we use to send messages to placehd, and store responses.
...
class CompactBlocksTest(PlacehTestFramework):
    ...
    # This test actually causes placehd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that placehd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for placehd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # placehd will not send blocktxn responses for blocks whose height is
