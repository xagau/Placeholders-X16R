...
class TestPlacehCli(PlacehTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `placeh-cli getinfo`")
        ...
        self.log.info("Compare responses from `placeh-cli -getinfo` and the RPCs data is retrieved from.")
