...
class BIP66Test(PlacehTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # placehd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and placehd produces more specific reject
            # reasons.
