...
#Set this to your placeh-cli program
cli = "placeh-cli"

mode = "-testnet"
mode = ""
rpc_port = 18766
#Set this information in your placeh.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
...
for i in range(23500,blockheight):
    ...
    for tx in txs:
        ...
        for vout in tx_detail.get('vout'):
            ...
            if (vout.get('scriptPubKey').get('asm')[86:98] == "OP_PHL_ASSET"):
                #print("Found OP_PHL_ASSET")
